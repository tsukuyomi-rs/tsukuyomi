...
mod tests {
    ...
    fn smoke_test() {
        ...
        {
            let inner_string = scope.container.get_inner::<String>().unwrap();
        ...
        assert_eq!(scope.get::<String>(0).map(String::as_str), Some("G"));
        assert_eq!(scope.get::<String>(1).map(String::as_str), Some("A"));
        assert_eq!(scope.get::<String>(2).map(String::as_str), Some("B"));
        assert_eq!(scope.get::<String>(3).map(String::as_str), Some("C"));
        assert_eq!(scope.get::<String>(4).map(String::as_str), Some("C"));
        assert_eq!(scope.get::<String>(5).map(String::as_str), Some("B"));
        assert_eq!(scope.get::<String>(6).map(String::as_str), Some("B"));
    }
}
*/
