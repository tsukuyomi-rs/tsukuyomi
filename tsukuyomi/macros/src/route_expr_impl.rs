...
t! {
    ...
    expected: {
        ...
        {
            tsukuyomi::app::route::Route::builder()
                .uri("/:id/people/:name/*path").expect("this is a bug")
                .with(tsukuyomi::extractor::param::pos(0usize))
