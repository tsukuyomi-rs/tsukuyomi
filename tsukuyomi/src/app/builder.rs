...
use super::route::{RouteConfig, RouteContext};
use super::scope::{ScopeConfig, ScopeContext};
use super::{App, AppData, Config, ModifierId, RouteData, RouteId, ScopeData};

#[cfg_attr(feature = "cargo-clippy", allow(stutter))]
pub(super) struct AppBuilderContext {
...
impl fmt::Debug for AppBuilderContext {
...
impl Default for AppBuilderContext {
    fn default() -> Self {
        Self {
            routes: vec![],
            scopes: vec![],
